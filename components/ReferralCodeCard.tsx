  ...
  return (
    <>
      <View style={s.outerWrapper}>
        ...
        <View style={s.card}>
          <LinearGradient colors={[colors.primary.main + '12', 'transparent']} style={StyleSheet.absoluteFill} />
          ...
          <View style={s.codeContainer}>
            ...
            <View style={s.actions}>
              <TouchableOpacity onPress={handleCopy} style={s.actionButton}>
                <Copy size={18} color={colors.neon.primary} />
              </TouchableOpacity>
              <TouchableOpacity onPress={handleShare} style={s.actionButton}>
                <Share2 size={18} color={colors.neon.primary} />
              </TouchableOpacity>
            </View>
          </View>
        </View>
...
const s = StyleSheet.create({
  ...
  codeText:     { fontFamily: 'Arimo-Bold', fontSize: 22, color: '#ffffff', letterSpacing: 2, textShadowColor: colors.neon.primary, textShadowOffset: { width: 0, height: 0 }, textShadowRadius: 10 },
  actions:      { flexDirection: 'row', gap: 4 },
  actionButton: { padding: 11, borderRadius: 10, backgroundColor: colors.primary.main + '14', borderWidth: 1, borderColor: colors.primary.main + '26' },
});