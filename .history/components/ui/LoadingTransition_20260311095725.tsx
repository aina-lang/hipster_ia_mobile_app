...
export const LoadingTransition = React.memo(({ onVideoFinish }: LoadingTransitionProps) => {
  ...
  return (
    <Animated.View exiting={FadeOut.duration(400)} style={styles.rootContainer}>
      ...
      {/* Conteneur principal qui commence APRÈS le TopBar */}
      <View style={styles.mainContent}>
        
        {/* Vidéo juste en dessous du TopBar */}
        ...
        {/* Contenu centré (particules, texte) */}
...
const styles = StyleSheet.create({
  ...
  mainContent: {
    flex: 1,
    // Pas de paddingTop car le TopBar est en absolute
    // La vidéo commence naturellement après le TopBar
  },
  center: {
    flex: 1,
  ...
  videoContainer: {
    width: '100%',
    height: 300, // Ajuste cette hauteur selon tes besoins
    // Plus de marginTop: 100
    backgroundColor: '#000',
    overflow: 'hidden',
  },
  particleAnchor: {
