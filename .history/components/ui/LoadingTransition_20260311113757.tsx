...
export const LoadingTransition = React.memo(({ onVideoFinish }: LoadingTransitionProps) => {
  ...
  <Text style={textStyles.h1}>Titre en Arimo Bold</Text>
<Text style={textStyles.body}>Texte normal en Arimo Regular</Text>
<Text style={textStyles.signature}>Signature en Brittany</Text>

// Si tu veux changer la couleur
<Text style={[textStyles.body, { color: '#00d4ff' }]}>
  Texte bleu en Arimo Regular
</Text>
</View>
