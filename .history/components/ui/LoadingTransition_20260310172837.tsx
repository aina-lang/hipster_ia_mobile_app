...
export const LoadingTransition = React.memo(({ onVideoFinish }: LoadingTransitionProps) => {
  ...
  return (
  <Animated.View exiting={FadeOut.duration(400)} style={[StyleSheet.absoluteFill, {backgroundColor: 'rgba(255,0,0,0.1)'}]}>
    <StatusBar style="light" hidden={true} />
    
    {!videoReady && <View style={[StyleSheet.absoluteFill, { backgroundColor: '#000' }]} />}

    <View style={[StyleSheet.absoluteFill, styles.videoContainer, {backgroundColor: 'rgba(0,255,0,0.1)'}]}>
    ...
    <View style={[styles.center, {backgroundColor: 'rgba(0,0,255,0.1)'}]}>
