...
export const LoadingTransition = React.memo(({ onVideoFinish }: LoadingTransitionProps) => {
  ...
  useEffect(() => {
    console.log('Default Text style:', Text.defaultProps?.style);
  ...
  return (
    <Animated.View exiting={FadeOut.duration(400)} style={StyleSheet.absoluteFill}>
      ...
      <View style={{
      position: 'absolute',
      top: 120, // Juste en dessous du TopBar
      left: 20,
      right: 20,
      ...
      borderWidth: 1,
      borderColor: '#00d4ff',
      zIndex: 200, // Pour être sûr d'être au-dessus
    }}>
      <Text style={{ fontSize: 14, color: '#00d4ff', fontWeight: 'bold', marginBottom: 8, textAlign: 'center' }}>
        🧪 TEST POLICES
      </Text>
      
      <View style={{ marginVertical: 4 }}>
        <Text style={{ fontSize: 16, color: '#ffffff' }}>📱 Police par défaut</Text>
        <Text style={{ fontSize: 16, color: '#ffffff', marginLeft: 16 }}>→ Ce texte</Text>
      </View>
      
      <View style={{ marginVertical: 4 }}>
        <Text style={{ fontSize: 16, color: '#ffffff' }}>🔵 Police Arial</Text>
        <Text style={{ fontFamily: 'Arial', fontSize: 16, color: '#ffffff', marginLeft: 16 }}>→ Ce texte en Arial</Text>
      </View>
      
      <View style={{ marginVertical: 4 }}>
        <Text style={{ fontSize: 16, color: '#ffffff' }}>🟢 Police Courier</Text>
        <Text style={{ fontFamily: 'Courier', fontSize: 16, color: '#ffffff', marginLeft: 16 }}>→ Ce texte en Courier</Text>
      </View>
      
      <View style={{ marginVertical: 4 }}>
        <Text style={{ fontSize: 16, color: '#ffffff' }}>⚪ Police Geist (test)</Text>
        <Text style={{ fontFamily: 'Geist', fontSize: 16, color: '#ffffff', marginLeft: 16 }}>→ Ce texte si Geist chargé</Text>
      </View>

      <Text style={{ fontSize: 12, color: '#888', marginTop: 8, textAlign: 'center' }}>
        Si Geist n'apparaît pas → police non chargée
      </Text>
    </View>
...
const styles = StyleSheet.create({
  ...
  topBar: {
    position: 'absolute',
    top: 0, left: 0, right: 0,
    height: 100, // fixer la hauteur totale
    paddingHorizontal: 20,
    zIndex: 100,
    justifyContent: 'center',
    alignItems: 'center',
