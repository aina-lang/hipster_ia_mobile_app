...
export const LoadingTransition = React.memo(({ onVideoFinish }: LoadingTransitionProps) => {
  ...
  <Text style={{ fontSize: 14, color: '#00d4ff', fontWeight: 'bold', marginBottom: 8, textAlign: 'center' }}>
    🧪 TEST POLICES - LETTRES RÉVÉLATRICES
  </Text>
  
  <View style={{ marginVertical: 8 }}>
    <Text style={{ fontSize: 18, color: '#ffaa00' }}>DÉFAUT</Text>
    <Text style={{ fontSize: 24, color: '#ffffff' }}>a g G y Y</Text>
  </View>
  
  <View style={{ marginVertical: 8 }}>
    <Text style={{ fontSize: 18, color: '#ffaa00' }}>ARIAL</Text>
    <Text style={{ fontFamily: 'Arial', fontSize: 24, color: '#ffffff' }}>a g G y Y</Text>
  </View>
  
  <View style={{ marginVertical: 8 }}>
    <Text style={{ fontSize: 18, color: '#ffaa00' }}>COURIER</Text>
    <Text style={{ fontFamily: 'Courier', fontSize: 24, color: '#ffffff' }}>a g G y Y</Text>
  </View>
  
  <View style={{ marginVertical: 8 }}>
    <Text style={{ fontSize: 18, color: '#ffaa00' }}>GEIST (si chargé)</Text>
    <Text style={{ fontFamily: 'Geist', fontSize: 24, color: '#ffffff' }}>a g G y Y</Text>
  </View>
</View>
