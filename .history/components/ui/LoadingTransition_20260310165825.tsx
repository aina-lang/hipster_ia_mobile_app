...
const BottomAuthSection = React.memo(({ isAuthenticated, onVideoFinish, textAnimProgress }: {
  ...
  return (
    <Animated.View style={[styles.bottomSection, animStyle]}>
      ...
      {/* Layer 2 : main button body — NOUVEAU STYLE APPLIQUÉ */}
      <Pressable onPress={handleWelcomePress} style={styles.primaryButtonWrapper}>
        <LinearGradient
          colors={["#264F8C", "#040612"]}
          start={{ x: 0.22, y: 0 }}  // 219deg
          end={{ x: 0.78, y: 1 }}     // 219deg
...
primaryButtonBody: {
    ...
    borderRadius: 5,
    borderWidth: 1,
    borderColor: "#FFFFFF6B",  // Blanc avec 42% d'opacité
    justifyContent: "center",
    alignItems: "center",
  },
...
primaryGlow: {
 ...
 primaryButtonText: {
    ...
    fontWeight: "600",
    letterSpacing: 0.6,
    color: "#ffffff",  // Remplace var(--e-global-color-734893e)
    textTransform: "none",
    textAlign: "center",
    paddingVertical: 15,
