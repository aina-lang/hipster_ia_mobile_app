  ...
  return (
    <View
      style={{
        ...
        alignItems: 'center',
        backgroundColor: '#09080E', // Fond noir solide
        borderBottomWidth: 1,
        borderBottomColor: 'rgba(0,212,255,0.2)', // Légère bordure néon subtile (optionnel)
      }}
    >
      <Text h1 style={{ color: '#ffffff' }}>{title}</Text>
    </View>
  );
};
