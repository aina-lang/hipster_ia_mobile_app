...
const styles = StyleSheet.create({
 ...
 mainSubText: {
  position: 'absolute',  // ← AJOUTE ceci pour pouvoir utiliser bottom
  bottom: 150,            // ← REMPLACE -430 par une valeur positive (50px du bas)
  left: 0,
  right: 0,
  fontSize: 28,
  fontFamily: 'Arimo-Bold',
  // fontWeight: '800',  ← Supprime (redondant avec fontFamily)
  letterSpacing: -0.3,
  color: '#ffffff',
  textAlign: 'center',
  paddingHorizontal: 20,
  // lineHeight: 20,      ← À décommenter si besoin
