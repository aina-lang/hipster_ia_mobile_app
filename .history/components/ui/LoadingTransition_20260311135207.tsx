...
const BottomAuthSection = React.memo(({ isAuthenticated, onVideoFinish, textAnimProgress }) => {
  ...
  return (
    <Animated.View style={[styles.container, animStyle]}>
      ...
      <View style={styles.row}>
        <FontAwesome5 name="angellist" size={14} color="#00d4ff" style={styles.glowIcon} />
        <Text small>
...
const styles = StyleSheet.create({
  ...
  glowIcon: {
    ...
    textShadowOffset: { width: 0, height: 0 },
    textShadowRadius: 8,
    // Pour un glow plus fort, on ne peut pas avoir plusieurs ombres
    // On utilise l'opacité et la couleur
    shadowColor: '#0077ff',
    shadowOffset: { width: 0, height: 0 },
    shadowOpacity: 0.8,
    shadowRadius: 20,
